...
//  if(checkbox[i] === true) {
//   `DELETE FROM films WHERE film_title = "" AND id = )
// } else if (checkbox[i] === true) {
//   `DELETE FROM books WHERE book_title = "" AND id = ),
// } else if (checkbox[i] === true){
//   `DELETE FROM restaurants restaurant_title = "" AND id = ),
// } else if (checkbox[i] === true){
//   `DELETE FROM products WHERE product_name = "" AND id = ),
// }
//
